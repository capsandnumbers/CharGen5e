...
OpenHandTechnique = feature("Open Hand Technique","Subclass",OpenHandTechniqueDesc,OpenHandTechniqueText,3)
...
WholenessOfBody = feature("Wholeness of Body","Subclass",WholenessOfBodyDesc,WholenessOfBodyText, 6,textFunc=WholenessOfBodyTextFunc)
...
Tranquility = feature("Tranquility","Subclass",TranquilityDesc,TranquilityText,11)
...
QuiveringPalm = feature("Quivering Palm","Subclass",QuiveringPalmDesc,QuiveringPalmText,17)
