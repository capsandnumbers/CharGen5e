...
ShelterOfTheFaithful = feature("Shelter of the Faithful", "Background", ShelterOfTheFaithfulDesc, ShelterOfTheFaithfulText)
...
AcolyteSetup = feature("AcolyteSetup", "Background", "",None, function = AcolyteSetupFunc, hideFeature = True)

Acolyte = background("Acolyte",{"skill":["Insight", "Religion"]},[ShelterOfTheFaithful],optionalProfs=[[allLanguages,'language',2]])
